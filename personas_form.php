...
<!-----------------------------------FIN ALERTAS------------------------------------------------------------->
                    <div class="row justify-content-center">
                        <div class="col-12 col-md-11 border border-1 rounded table-responsive py-3">
        ...
        ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <button type="button" class="text-info" style="border:none; background-color:transparent;" title="Asignar rol" data-bs-toggle="modal" data-bs-target="#modal-rol-usuario-<?php echo $fila->id_persona;?>">
                                            <i class="bi bi-person-rolodex"></i>
                                        </button>
                                    </td> 
                                    <td class="text-center">
                                        <button type="button" style="border:none; background-color:transparent;color:#53CA0A;" title="Editar" data-bs-toggle="modal" data-bs-target="#modal-edit-usuario-<?php echo $fila->id_persona;?>">
                                            <i class="bi bi-pencil-square"></i>
                                        </button>
                                    </td>   
                                    <td class="text-center">
                                        <button type="button" class="text-danger" style="border:none; background-color:transparent;" title="Borrar" data-bs-toggle="modal" data-bs-target="#modal-delete-usuario-<?php echo $fila->id_persona;?>">
